        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            <div class="app-brand demo">
              <a href="index.html" class="app-brand-link">
                ...
                <span class="demo menu-text fw-bolder ms-2" style="font-size: 15px">E-Learn</span>
              </a>
            ...
            <ul class="menu-inner py-1">
              ...
              <!-- Materials -->
              <li class="menu-item {{ Route::is('materials*') ? 'active' : '' }}">
              ...
              <!-- Assignments -->
              <li class="menu-item {{ Route::is('assignments*') ? 'active' : '' }}">
              ...
              <!-- Attendance -->
              <li class="menu-item {{ Route::is('attendances*') ? 'active' : '' }}">
